...
export const CHANGELOG_DATA = [
    {
        ...
        date: "2025-10-22",
        changes: [
            "Оновлено теми: нові візуальні ефекти, покращена читабельність тексту в світлих темах.",
            "Графік: всі колонки днів тепер мають фіксовану однакову ширину для кращого вигляду.",
            "Графік: вихідні дні тепер мають додаткове підсвічування.",
            "Додано інтерактивні елементи та секрети для кожної теми."
        ]
    },
    {
        version: "1.4.1",
        date: "2025-10-20",
        changes: [
            "Змінено логіку відображення недоступних: тепер люди, які мають хоча б один наряд в місяці, залишаються в активному списку, навіть якщо вони хворіють решту часу.",
            "Покращено внесення відсутності (лікарняний, відпустка тощо): тепер при виборі інструменту відкривається вікно для вибору дати завершення, що дозволяє швидко відмічати довгі періоди.",
            "Синхронізація відсутності: при відмітці відсутності для людини, цей статус автоматично дублюється у всіх категоріях, де вона знаходиться."
        ]
    },
    {
        version: "1.4",
